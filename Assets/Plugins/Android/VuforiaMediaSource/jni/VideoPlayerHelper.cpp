...
Java_com_qualcomm_VuforiaMedia_VideoPlayerHelper_initMediaTexture(JNIEnv* env, jobject obj)
{
...
Java_com_qualcomm_VuforiaMedia_VideoPlayerHelper_bindMediaTexture(JNIEnv *, jobject, jint mediaTextureID)
{
...
JNIEXPORT int JNICALL
Java_com_qualcomm_VuforiaMedia_VideoPlayerHelper_initFBO(JNIEnv* env, jobject obj, jint destTextureID, int videoWidth, int videoHeight)
{
...
JNIEXPORT void JNICALL
Java_com_qualcomm_VuforiaMedia_VideoPlayerHelper_copyTexture(JNIEnv* env, jobject obj, jint mediaTextureID, jint destTextureID, jint fbo,
